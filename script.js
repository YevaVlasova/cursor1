...
function assignThemes(pairs, themes) {
  ...
  for (let i = 0; i < pairs.length; i++) {
    ...
    const pairedTheme = [pair.join(' і ') + " отримали тему " + theme]; // Трохи прикрашаю додатковим текстом для поліпшення читабельності, в цьому масиві об'єдную пари студентів і даю їм тему для опрацювання
